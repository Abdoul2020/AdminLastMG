								...
								<div className="card-header border-0 pt-6">
									...
									<div className="card-title">
										<div className="d-flex align-items-center position-relative my-1">
											...
											<input type="text" data-kt-customer-table-filter="search" className="form-control form-control-solid w-250px ps-12" placeholder="Search Customers" />
										</div>
											...
											<div className="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
												...
												<div className="px-7 py-5">
													...
													<div className="mb-10">
														...
														<select className="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option"
									...
									<table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
										<thead>
											<tr className="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
												...
												<th className="min-w-125px"> Unvan ID</th>
												<th className="min-w-125px"> Başlık </th>
												<th className="min-w-125px">Başlangıç Tarihi</th>
										...
										<tbody className="fw-semibold text-gray-600">
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
												</td>
												<td>
												...
												<img src="assets/media/svg/card-logos/mastercard.svg" className="w-35px me-3" alt="" />**** 8513</td>
												...
												<td className="text-end">
													...
													<div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div className="menu-item px-3">
															<a href="../../demo3/dist/apps/customers/view.html" className="menu-link px-3">View</a>
														</div>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
												</td>
												<td>
												...
												<td>Google</td>
												<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" className="w-35px me-3" alt="" />**** 5050</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Max Smith</a>
												</td>
												<td>
												...
												<td>Bistro Union</td>
												<td data-filter="mastercard">
												<img src="assets/media/svg/card-logos/mastercard.svg" className="w-35px me-3" alt="" />**** 8582</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
												</td>
												<td>
												...
												<img src="assets/media/svg/card-logos/american-express.svg" className="w-35px me-3" alt="" />**** 6098</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
												</td>
												<td>
												...
												<td>-</td>
												<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" className="w-35px me-3" alt="" />**** 3118</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
												</td>
												<td>
												...
												<td>Keenthemes</td>
												<td data-filter="american_express">
												<img src="assets/media/svg/card-logos/american-express.svg" className="w-35px me-3" alt="" />**** 1248</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
												</td>
												<td>
												...
												<td>Paypal</td>
												<td data-filter="mastercard">
												<img src="assets/media/svg/card-logos/mastercard.svg" className="w-35px me-3" alt="" />**** 7500</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
												</td>
												<td>
												...
												<td>-</td>
												<td data-filter="american_express">
												<img src="assets/media/svg/card-logos/american-express.svg" className="w-35px me-3" alt="" />**** 3544</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
												</td>
												<td>
												...
												<td>Paramount</td>
												<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" className="w-35px me-3" alt="" />**** 1103</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
												</td>
												<td>
												...
												<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" className="w-35px me-3" alt="" />**** 3690</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
												</td>
												<td>
												...
												<td data-filter="mastercard">
												<img src="assets/media/svg/card-logos/mastercard.svg" className="w-35px me-3" alt="" />**** 6664</td>
											...
											<tr>
												...
												<td>
													<a href="../../demo3/dist/apps/customers/view.html" className="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
												</td>
												<td>
												...
												<td data-filter="american_express">
												<img src="assets/media/svg/card-logos/american-express.svg" className="w-35px me-3" alt="" />**** 9360</td>
							...
							<div className="modal fade" id="kt_modal_add_customer" tabIndex={-1} aria-hidden="true">
								...
								<div className="modal-dialog modal-dialog-centered mw-650px">
									...
									<div className="modal-content">
										...
										<form className="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="../../demo3/dist/apps/customers/list.html">
											...
											<div className="modal-body py-10 px-lg-17">
												...
												<div className="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
													...
													<div className="fw-bold fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
													...
													<div id="kt_modal_add_customer_billing_info" className="collapse show">
														...
														<div className="d-flex flex-column mb-7 fv-row">
															...
															<select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a Country..." data-dropdown-parent="#kt_modal_add_customer" className="form-select form-select-solid fw-bold">
														...
														<div className="fv-row mb-7">
															...
															<div className="d-flex flex-stack">
																...
																<label className="form-check form-switch form-check-custom form-check-solid">
																	...
																	<input className="form-check-input" name="billing" type="checkbox" value="1" id="kt_modal_add_customer_billing"
                                                                      />
											...
											<form id="kt_customers_export_form" className="form" action="#">
												...
												<div className="fv-row mb-10">
													...
													<select data-control="select2" data-placeholder="Select a format" data-hide-search="true"
                                                     name="format" className="form-select form-select-solid">
												...
												<div className="row fv-row mb-15">
													...
													<div className="d-flex flex-column">
														...
														<label className="form-check form-check-custom form-check-sm form-check-solid mb-3">
															<input className="form-check-input" type="checkbox" value="1"  name="payment_type" />
															<span className="form-check-label text-gray-600 fw-semibold">All</span>
														</label>
														
														
														<label className="form-check form-check-custom form-check-sm form-check-solid mb-3">
															<input className="form-check-input" type="checkbox" value="2"  name="payment_type" />

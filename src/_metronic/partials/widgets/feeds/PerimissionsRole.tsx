                            ...
                            <table className="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                                ...
                                <tbody className="fw-semibold text-gray-600">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../../demo3/dist/apps/user-management/roles/view.html" className="badge badge-light-primary fs-7 m-1">Administrator</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../../demo3/dist/apps/user-management/roles/view.html" className="badge badge-light-primary fs-7 m-1">Administrator</a>
                                            <a href="../../demo3/dist/apps/user-management/roles/view.html" className="badge badge-light-danger fs-7 m-1">Developer</a>
                                            <a href="../../demo3/dist/apps/user-management/roles/view.html" className="badge badge-light-success fs-7 m-1">Analyst</a>
                                            <a href="../../demo3/dist/apps/user-management/roles/view.html" className="badge badge-light-info fs-7 m-1">Support</a>
                                            <a href="../../demo3/dist/apps/user-management/roles/view.html" className="badge badge-light-warning fs-7 m-1">Trial</a>
                                        </td>
...
export default PerimissionsRole

...
//Import from another rule
import { useSelector, useDispatch } from "react-redux";
import {get_Expert_Image} from "../../service/redux/authExpert/user_ExpertSlice"
...
const PrivateRoutes = () => {
  ...
  //get the user data
  const userData= useSelector((state:any)=>state.expert_ProfileSlice.value);
  ...
  useEffect(() => {
    ...
    if(userData && userData._id){
      dispatch(get_Expert_Image({userId: userData._id}));
    }
  }, [userData])
